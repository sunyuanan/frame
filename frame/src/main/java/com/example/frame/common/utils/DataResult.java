...
import com.example.frame.common.exception.code.ResponseCodeInterface;
import io.swagger.annotations.ApiModelProperty;
import lombok.Data;

/**
 * Created by Administrator on 2021/10/20 0020 18:03
 */
@Data
public class DataResult<T> {
    ...
    /**
     * 自定义操作失败 baseResponseCode 对象
     */
    public static <T> DataResult fail(BaseResponseCode baseResponseCode) {
